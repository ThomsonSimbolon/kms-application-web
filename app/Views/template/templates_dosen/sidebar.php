<ul class="nav flex-column side-bar text-decoration-none mx-2 py-2">
    <a href="<?= base_url('dosen/dashboard'); ?>" class="sidebar-brand text-dark my-0 text-decoration-none h4 d-flex align-items-center">
    ...
    <li class="nav-item <?php echo ($active == 'dashboard') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/dashboard'); ?>"><i class="fas fa-house"></i>
            Dashboard</a>
    </li>
    <li class="nav-item <?php echo ($active == 'profile') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/profile'); ?>"><i class="fas fa-address-card"></i>
            Profile</a>
    </li>
    <li class="nav-item <?php echo ($active == 'materi') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/materi'); ?>"><i class="fas fa-book-open-reader"></i>
            Materi</a>
    </li>
    <li class="nav-item <?php echo ($active == 'pengetahuan') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/pengetahuan'); ?>"><i class="fas fa-book-open"></i>
            Pengetahuan</a>
    </li>
    <li class="nav-item <?php echo ($active == 'dokumen') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/document'); ?>"><i class="fas fa-file"></i> Dokumen</a>
    </li>
    <li class="nav-item <?php echo ($active == 'discussion') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/discussion'); ?>"><i class="fas fa-comment"></i> Forum
            Diskusi</a>
    </li>
    <li class="nav-item <?php echo ($active == 'berita') ? 'active' : ''; ?>">
        <a class="nav-link" href="<?= base_url('/dosen/berita'); ?>"><i class="fas fa-newspaper"></i> Berita</a>
    </li>
</ul>