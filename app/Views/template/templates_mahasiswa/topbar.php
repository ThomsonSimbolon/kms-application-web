<nav class="navbar shadow navbar-expand-lg sticky-top top-0 py-3 navbar-light bg-light">
    <div class="container-fluid pr-0">
        <a class="navbar-brand d-flex align-items-center" href="<?= base_url('mahasiswa/dashboard'); ?>"><img
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto my-auto">
                <li class="nav-item nav-1 <?php echo ($active == 'dashboard') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?= base_url('/mahasiswa/dashboard') ?>">Dashboard</a>
                </li>
                <li class="nav-item nav-1 <?php echo ($active == 'materi') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?= base_url('/mahasiswa/materi'); ?>">Materi</a>
                </li>
                <li class="nav-item nav-1 <?php echo ($active == 'pengetahuan') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?= base_url('/mahasiswa/pengetahuan') ?>">Pengetahuan</a>
                </li>
                <li class="nav-item nav-1 <?php echo ($active == 'dokumen') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?= base_url('/mahasiswa/document') ?>">Dokumen</a>
                </li>
                <li class="nav-item nav-1 <?php echo ($active == 'discussion') ? 'active' : ''; ?>">
                    <a class="nav-link" href="<?= base_url('/mahasiswa/discussion') ?>">Forum Diskusi</a>
                </li>
                ...
                <li class="nav-item dropdown arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item text-gray-700" href="<?= base_url('mahasiswa/berita') ?>">
                            <i class="fas fa-newspaper fa-sm fa-fw mr-2 text-gray-400"></i>
                            Berita
                        </a>
                        <a class="dropdown-item text-gray-700" href="<?= base_url('mahasiswa/faq'); ?>">
                ...
                <!-- Nav Item - Alerts -->
                <li class="nav-item pb-0 dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item text-center small text-gray-500"
                            href="<?= base_url('mahasiswa/notifikasi'); ?>">Tampilkan Semua Notifikasi</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        aria-labelledby="userDropdown">
                        <a class="dropdown-item text-gray-700" href="<?= base_url('mahasiswa/profile') ?>">
                            <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                            Profile
                        </a>
                        <a class="dropdown-item text-gray-700" href="<?= base_url('mahasiswa/setting'); ?>">
