                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="card" style="width: 750px;">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h5 class="card-title my-0 text-primary">Tambah Pengetahuan</h5>
                            ...
                            <div class="card-body">
                                <form action="<?= site_url('admin/pengetahuan/create/') ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                    <?= csrf_field() ?>
                                    <div class="form-group">
                                        <label for="nama_lengkap">Nama Lengkap</label>
                                        <input type="text" class="form-control <?= session('errors.nama_lengkap') ? 'is-invalid' : null ?>" id="nama_lengkap" name="nama_lengkap" autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.judul_pengetahuan') ? 'is-invalid' : null ?>" id="judul_pengetahuan" name="judul_pengetahuan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.jenis_pengetahuan') ? 'is-invalid' : null ?>" id="jenis_pengetahuan" name="jenis_pengetahuan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control <?= session('errors.deskripsi_pengetahuan') ? 'is-invalid' : null ?>" id="deskripsi" name="deskripsi_pengetahuan" cols="30" rows="10"></textarea>
