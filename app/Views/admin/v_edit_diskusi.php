        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title my-0 text-primary">Edit Data Diskusi</h4>
                    <a href="<?= base_url('admin/discussion'); ?>" class="text-danger"><i
                ...
                <div class="card-body">
                    <form action="<?= site_url('admin/discussion/update/' . $diskusi->id_forum); ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            <label for="id_user">ID User</label>
                            <input type="text"
                                class="form-control  <?= session('errors.id_user') ? 'is-invalid' : null ?>"
                                id="id_user" name="id_user" value="<?= old('id_user', $diskusi->id_user); ?>" readonly>
                            <?php if (session('errors.id_user')) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control  <?= session('errors.judul_forum') ? 'is-invalid' : null ?>"
                                id="judul_forum" name="judul_forum"
                                value="<?= old('judul_forum', $diskusi->judul_forum); ?>">
