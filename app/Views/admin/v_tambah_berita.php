        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url('admin/berita/create'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
                </div>
                ...
                <div class="card-body">
                    <form action="<?= site_url('admin/berita/create') ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  <?= session('errors.isi') ? 'is-invalid' : null ?>" id="deskripsi" name="isi" rows="5"><?= old('isi'); ?></textarea>
