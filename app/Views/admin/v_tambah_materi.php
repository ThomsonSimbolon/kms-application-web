            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h4 class="card-title my-0 text-primary">Tambah Data Materi</h4>
                        <a href="<?= base_url('admin/materi'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
                    </div>
                    <?php $validation = \Config\Services::validation(); ?>
                    <div class="card-body">
                        <form action="<?= site_url('admin/materi/create') ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= session('errors.mata_kuliah') ? 'is-invalid' : null ?>" id="mata_kuliah" name="mata_kuliah" value="<?= old('mata_kuliah') ?>" placeholder="Masukkan mata kuliah" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= session('errors.judul_materi') ? 'is-invalid' : null ?>" id="judul_materi" name="judul_materi" value="<?= old('judul_materi') ?>" placeholder="Masukkan judul materi">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?= session('errors.program_studi') ? 'is-invalid' : null ?>" aria-label="Default select example" id="program_studi" name="program_studi" value="<?= old('program_studi'); ?>">
