...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        ...
        <div class="card-body">
            <form action="<?= site_url('pegawai/pengetahuan/update/' . $pengetahuan->id_pengetahuan) ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        id="judul_pengetahuan" name="judul_pengetahuan" value="<?= $pengetahuan->judul_pengetahuan; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        id="jenis_pengetahuan" name="jenis_pengetahuan" value="<?= $pengetahuan->jenis_pengetahuan; ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?= session('errors.deskripsi_pengetahuan') ? 'is-invalid' : null ?>"
                        id="deskripsi_pengetahuan" name="deskripsi_pengetahuan" cols="30"
