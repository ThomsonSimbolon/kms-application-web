...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            ...
            <a href="<?= site_url('/pegawai/profile'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
        </div>
        ...
        <div class="card-body">
            <?php if ($profile) { ?>
                <form action="<?= site_url('/pegawai/profile/update'); ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_pegawai" id="id_pegawai" value="<?= $profile['id_pegawai']; ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nidn" name="nidn" value="<?= $profile['nidn']; ?>">
                            </div>
                            <div class="form-group">
                        ...
                        <div class=" col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="upload_foto" name="upload_foto" value="<?= $profile['upload_foto']; ?>">
                    ...
                    <a href="<?= site_url('/pegawai/profile'); ?>" class="btn btn-secondary">Kembali</a>
