...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            ...
            <a href="<?= base_url('pegawai/dashboard'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
        </div>
        ...
        <div class="card-body">
            ...
            <a href="<?= site_url('pegawai/setting/edit/'); ?>" class="btn btn-primary">Ubah Data</a>
        </div>
    </div>
</div>
