...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        ...
        <div class="card-body">
            <form action="<?= site_url('pegawai/discussion/update/' . $diskusi->id_forum); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="form-group">
                    <label for="nama_lengkap">Nama Lengkap</label>
                    <input type="text" class="form-control  <?= session('errors.nama_lengkap') ? 'is-invalid' : null ?>" id="nama_lengkap" name="nama_lengkap" value="<?= old('nama_lengkap', $diskusi->nama_lengkap); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  <?= session('errors.judul_forum') ? 'is-invalid' : null ?>" id="judul_forum" name="judul_forum" value="<?= old('judul_forum', $diskusi->judul_forum); ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control  <?= session('errors.deskripsi') ? 'is-invalid' : null ?>" id="deskripsi" name="deskripsi" rows="3"><?= old('deskripsi', $diskusi->deskripsi); ?></textarea>
