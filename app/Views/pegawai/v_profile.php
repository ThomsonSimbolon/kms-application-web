                    ...
                    <div class="d-inline-block">
                        <div class="container">
                            <div class="text-center">
                                <img src="<?= base_url('uploads/' . $profile['upload_foto']); ?>" class="img-fluid rounded-circle w-75 p-2 shadow img-profile-all" alt="Logo Profile">
                                <h4 class="card-title mt-2 text-center"><?= $profile['nama_lengkap']; ?> -
                                    <?= $profile['id_user']; ?>
                                </h4>
                                <a href="<?= site_url('/pegawai/profile/edit'); ?>" class="btn btn-primary btn-sm">Edit
                                    Profile</a>
                            </div>
                        </div>
                    </div>
