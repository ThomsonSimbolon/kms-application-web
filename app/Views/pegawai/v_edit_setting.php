...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            <h5 class="card-title my-0 text-white">Edit Setting</h5>
            <a href="<?= site_url('pegawai/setting'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
        </div>
        ...
        <div class="card-body">
            <form action="<?= site_url('pegawai/setting/update'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="level" name="level" value="<?= $setting->level; ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="status">Level</label>
                    <input type="text" class="form-control" id="status" name="status" value="<?= $setting->status; ?>" readonly>
                </div>
