...
<div class="mb-3">
    <a href="<?= base_url('pegawai/discussion/pribadi'); ?>" class="btn btn-primary bg-gradient-primary border-0 btn-sm shadow-sm"><i class="fas fa-id-badge"></i> Data
        Pribadi</a>
</div>
...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            ...
            <a href="<?= base_url('pegawai/discussion/add'); ?>" class="btn btn-primary btn-sm shadow-sm">Tambah</a>
        </div>
                ...
                <?php foreach ($d as $d) : ?>
                    <div class="card shadow-sm" style="margin-top: 20px;">
                        <div class="card-body">
                            ...
                            <a href="<?= site_url('pegawai/discussion/detail/' . $d->id_forum); ?>" class="btn btn-info btn-sm shadow-sm"><i class="fas fa-eye"></i> Lihat</a>
                        </div>
