        ...
        <div class="card-body">
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <p class="card-text text-gray-500"><small class="text-muted" style="font-size: 12px;">
                ...
                <div class="card-footer mt-0 mb-0 pb-0 bg-transparent">
                    ...
                    <form action="<?= site_url('pegawai/discussion/detail/komentar'); ?>" method="post" class="my-1"
                        autocomplete="off">
                        <?= csrf_field(); ?>
                        ...
                        <div class="row mb-3 d-flex align-items-center">
                            ...
                            <div class="col-md-10 col-lg-11">
                                <div class="input-group">
                                    <input type="text"
                                        class="form-control shadow-none border-1 <?= session('errors.komentar') ? 'is-invalid' : null ?>"
                                        id="komentar" name="komentar" value="<?= old('komentar'); ?>"
                                        placeholder="Masukkan komentar">
                                    <div class="input-group-append">
                                        <button type="submit"
                                            class="btn btn-outline-secondary shadow-none bg-transparent border-1 d-block"
                                            id="button-addon2">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form
                                        action="<?= site_url('pegawai/discussion/detail/komentar/update/' . $comment->id_komentar); ?>"
                                        method="post">
                                        <?= csrf_field(); ?>
