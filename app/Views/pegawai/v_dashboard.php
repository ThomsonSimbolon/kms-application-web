                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="d-flex align-items-center justify-content-center">
                            <img src="<?= base_url('assets/custom-css/img/logo_kms.png'); ?>" class="img-fluid px-2"
                                alt="Logo Favicon"
                                style="z-index: 1000; max-width: 400px !important; width: 100% !important;">
                        </div>
                        <div class="row d-flex-align-items-center justify-content-center text-center">
                            <div class="col-md">
                                <div class="container w-50 text-center mt-2">
                                    <marquee behavior="" direction="">
                                        <h3 class="card-text">Selamat Datang Di Halaman Pegawai</h3>
                                    </marquee>
                                </div>
