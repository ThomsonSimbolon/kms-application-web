...
<div class="mb-3">
    <a href="<?= base_url('pegawai/pengetahuan/data-pribadi'); ?>" class="btn btn-primary bg-gradient-primary btn-sm shadow"><i class="fas fa-id-badge"></i> Data Pribadi</a>
</div>
                ...
                <tbody>
                    ...
                    foreach ($p as $p) : ?>
                        <tr>
                            ...
                            <td class="mx-auto">
                                <a href="<?= site_url('pegawai/pengetahuan/detail/' . $p->id_pengetahuan); ?>" class="btn btn-sm btn-info"><i class="fas fa-eye text-center"></i> Lihat</a>
                                <a href="<?= site_url('pegawai/pengetahuan/download/' . $p->id_pengetahuan) ?>" class="btn btn-warning btn-sm btn-aksi"><i class="fas fa-download text-center"></i>
                                    Download</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
