...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        ...
        <div class="card-body">
            <form action="<?= site_url('dosen/materi/update/' . $materi->id_materi) ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('errors.nama_lengkap') ? 'is-invalid' : null ?>"
                        ...
                        value="<?= old('mata_knama_lengkapunama_lengkapliah', $materi->nama_lengkap) ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('errors.mata_kuliah') ? 'is-invalid' : null ?>"
                        id="mata_kuliah" name="mata_kuliah" value="<?= old('mata_kuliah', $materi->mata_kuliah) ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('errors.judul_materi') ? 'is-invalid' : null ?>"
                        id="judul_materi" name="judul_materi" value="<?= old('judul_materi', $materi->judul_materi) ?>"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control <?= session('errors.program_studi') ? 'is-invalid' : null ?>"
                        ...
                        <option value="Teknik Informatika"
                            <?= $materi->program_studi == 'Teknik Informatika' ? 'selected' : ''; ?>>
                            Teknik
                            Informatika</option>
                        <option value="Sistem Informasi"
                            <?= $materi->program_studi == 'Sistem Informasi' ? 'selected' : ''; ?>>
                            Sistem
                            Informasi</option>
