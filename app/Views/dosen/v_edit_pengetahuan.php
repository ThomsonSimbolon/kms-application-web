...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            <h5 class="card-title my-0 text-white">Edit Data Pengetahuan</h5>
        ...
        <div class="card-body">
            <form action="<?= site_url('dosen/pengetahuan/update/' . $pengetahuan->id_pengetahuan) ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('errors.judul_pengetahuan') ? 'is-invalid' : null ?>" id="judul_pengetahuan" name="judul_pengetahuan" value="<?= $pengetahuan->judul_pengetahuan; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= session('errors.jenis_pengetahuan') ? 'is-invalid' : null ?>" id="jenis_pengetahuan" name="jenis_pengetahuan" value="<?= $pengetahuan->jenis_pengetahuan; ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control <?= session('errors.deskripsi_pengetahuan') ? 'is-invalid' : null ?>" id="deskripsi" name="deskripsi_pengetahuan" cols="30" rows="10"><?= $pengetahuan->deskripsi_pengetahuan; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="file" name="file_path" value="<?= $pengetahuan->file_path; ?>">
