...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            <h5 class="card-title my-0 text-white">Detail Data Diskusi</h5>
        ...
        <div class="card-body">
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <p class="card-text text-gray-500"><small class="text-muted" style="color: #fff !important; font-size: 10px;">
                ...
                <div class="card-footer mt-0 mb-0 pb-0 bg-transparent">
                    ...
                    <form action="<?= site_url('dosen/discussion/detail/komentar'); ?>" method="post" class="my-1" autocomplete="off">
                        <?= csrf_field(); ?>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?= site_url('dosen/discussion/detail/komentar/update/' . $comment->id_komentar); ?>" method="post">
                                                    <?= csrf_field(); ?>
