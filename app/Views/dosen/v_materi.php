...
<div class="mb-3">
    <a href="<?= base_url('dosen/materi/data-pribadi'); ?>" class="btn btn-primary bg-gradient-primary btn-sm shadow"><i class="fas fa-id-badge"></i> Data Pribadi</a>
</div>
...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    ...
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            ...
            <a href="<?= base_url('dosen/materi/add'); ?>" class="btn btn-primary btn-sm shadow">Tambah</a>
        </div>
                ...
                <tbody>
                    ...
                    foreach ($m as $m) : ?>
                        <tr>
                            ...
                            <td class="mx-auto">
                                <a href="<?= site_url('dosen/materi/detail/' . $m->id_materi); ?>" class="btn btn-sm btn-info"><i class="fas fa-eye text-center"></i> Lihat</a>
                                <a href="<?= site_url('dosen/materi/download/' . $m->id_materi) ?>" class="btn btn-warning btn-sm btn-aksi"><i class="fas fa-download text-center"></i>
                                    Download</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
