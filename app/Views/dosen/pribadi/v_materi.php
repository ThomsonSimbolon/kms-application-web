                    ...
                    foreach ($materies as $materi) : ?>
                        <?php if ($materi->status === 'diterima') : ?>
                            <tr>
                                ...
                                <td class="mx-auto">
                                    <a href="<?= site_url('dosen/materi/detail/' . $materi->id_materi); ?>" class="btn btn-sm btn-info"><i class="fas fa-eye text-center"></i> Lihat</a>
                                    <a href="<?= site_url('dosen/materi/edit/' . $materi->id_materi); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit text-center"></i> Edit</a>
                                </td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
