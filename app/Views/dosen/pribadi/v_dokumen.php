                    ...
                    foreach ($documents as $document) : ?>
                        <?php if ($document->status === 'diterima') : ?>
                            <tr>
                                ...
                                <td class="mx-auto">
                                    <a href="<?= site_url('dosen/document/detail/' . $document->id_dokumen) ?>" class="btn btn-info btn-sm"><i class="fas fa-eye text-center"></i> Lihat</a>
                                    <a href="<?= site_url('dosen/document/edit/' . $document->id_dokumen); ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit text-center"></i> Edit</a>
                                </td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
