    ...
    <div class="wrapper">
        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex justify-content-center mb-4 text-judul">
                <h2 class="text-primary font-weight-bold text-uppercase heading-content">Sejarah</h2>
            </div>
            <div class="row p-3">
                <div class="col-lg-12 col-md-12 col-12">
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">Sejarah Fakultas Ilmu Komputer
                        Universitas Lancang Kuning</p>
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">
                        Fakultas Ilmu Komputer Universitas Lancang Kuning yang berkedudukan di Pekanbaru memikul tugas
                        dan
                        tanggung jawab untuk mengembangkan sumber daya manusia sesuai kebutuhan pembangunan, dengan
                        mengingat pula kedudukannya sebagai bagian dari masyarakat ilmiah yang bersifat universal.
                    </p>
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">1. Sebagai salah satu Fakultas
                        pada Universitas Lancang Kuning.</p>
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">2. Fakultas Ilmu Komputer
                        (Fasilkom) berdiri pada tanggal 3 Agustus 2006.</p>
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">3. Kampusnya berlokasi Jln. Yos
                        Sudarso KM. 8 Rumbai, No. Telpon / Whatsapp 0811-753-2015.</p>
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">4. Fakultas Ilmu Komputer
                        Universitas Lancang Kuning memiliki tiga Program Studi, yaitu :</p>
                    <p style="margin-top: 0; font-size: 1.2rem; text-align: justify;">
                        Program Studi Teknik Informatika jenjang S-1 (Akreditasi B) SK BAN-PT No.
                        13760/SK/BAN-PT/Ak-PPJ/S/XII/2021
                        Program Studi Sistem Informasi jenjang S-1 (Akreditasi Baik Sekali) SK BAN-PT No.
                        7085/SK/BAN-PT/Ak/S/X/2022
                        Program Studi Bisnis Digital jenang S-1 (Terkakreditasi Baik)
                    </p>
                </div>
            </div>
        </div>
