                ...
                <div class="col-lg-6 mb-3">
                    <div class="card card-berita shadow h-100">
                        <div class="ml-3 d-flex align-items-center">
                            <p class="mt-3 mb-3" style="font-size: 1.2rem;"><?= esc($beritaItem->penulis); ?> <i
                                    class="fas fa fa-angle-right" style="font-size: 1rem;"></i>
                                <a href="<?= esc($beritaItem->url); ?>"
                                    target="_blank"><?= esc($beritaItem->judul); ?></a>
                            </p>
                        </div>
                        <img src="<?= base_url('/assets/custom-css/img/img-upload/' . $beritaItem->file_path); ?>"
                            class="card-img-top" alt="Gambar Berita" style="height: 350px; object-fit: cover;">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <small
                                class="text-muted"><?= date('d-m-Y H:i:s', strtotime($beritaItem->tgl_publikasi)) ?></small>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
