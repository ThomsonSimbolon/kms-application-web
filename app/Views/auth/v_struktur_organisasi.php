    ...
    <div class="wrapper">
        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex justify-content-center mb-4 text-judul">
                <h2 class="text-primary font-weight-bold text-uppercase heading-content">Struktur Organisasi</h2>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <img src="<?= base_url('assets/custom-css/img/STRUKTUR.png'); ?>" alt="Struktur Organisasi"
                        class="img-fluid">
                </div>
            </div>
        </div>
