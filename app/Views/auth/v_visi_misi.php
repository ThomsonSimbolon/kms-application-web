    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-12">
                        <div class="breadcrumb-text">
                            ...
                            <div class="breadcrumb-bar text-center text-light">
                                ...
                                <span class="text-white">Visi Dan Misi</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mt-5 mb-5">
            <div class="d-flex justify-content-center mb-4 text-judul">
                <h2 class="text-primary font-weight-bold text-uppercase heading-content">Visi Dan Misi</h2>
            </div>
            <div class="row p-3">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-visi">
                        <p>Visi dan Misi Fakultas Ilmu Komputer</p>
                        <p>Visi</p>
                        <p>Menjadi Fakultas Ilmu Komputer unggul di wilayah Sumatera berlandaskan nilai-nilai budaya
                            melayu pada tahun 2025.</p>
                        <p>Misi</p>
                        <p>
                            1. Menyelenggarakan pendidikan di bidang komputer yang unggul dan profesional serta mampu
                            memenuhi kebutuhan masyarakat dan dapat beradaptasi dengan perkembangan teknologi
                        </p>
                        <p>
                            2. Melakukan penelitian-penelitian yang berkualitas di bidang komputer yang dapat
                            dipublikasikan di level regional dan nasional.
                        </p>
                        <p>
                            3. Melakukan pengabdian masyarakat yang dapat meningkatkan kualitas masyarakat dibidang
                            komputer.
                        </p>
                        <p>
