...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            ...
            <a href="<?= base_url('mahasiswa/pengetahuan'); ?>" class="text-danger"><i
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= session('errors.nama_lengkap') ? 'is-invalid' : null ?>"
                    id="nama_lengkap" name="nama_lengkap" value="<?= $pengetahuan->nama_lengkap; ?>" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="judul_pengetahuan" name="judul_pengetahuan"
                    value="<?= $pengetahuan->judul_pengetahuan; ?>" readonly>
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jenis_pengetahuan" name="jenis_pengetahuan"
                    value="<?= $pengetahuan->jenis_pengetahuan; ?>" readonly>
            </div>
            <div class="form-group">
                <label for="deskripsi_pengetahuan">Deskripsi</label>
                <textarea class="form-control" id="deskripsi" name="deskripsi_pengetahuan" cols="30" rows="10"
                    readonly><?= $pengetahuan->deskripsi_pengetahuan; ?></textarea>
            </div>
            <div class="form-group">
