...
<div class="container-fluid px-0 mx-0 content-2 rounded">
    <div class="card shadow px-0">
        <div class="card-header border border-1 d-flex align-items-center justify-content-between">
            ...
            <a href="<?= base_url('mahasiswa/discussion/add'); ?>" class="btn btn-success btn-sm shadow-sm">Tambah</a>
        </div>
        ...
        <?php endif; ?>
        <div class="card-body">
            <a href="<?= base_url('mahasiswa/discussion/pribadi'); ?>"
                class="btn btn-success bg-gradient-success border-0 btn-sm shadow-sm">Data Pribadi</a>
            <?php if (empty($d)) : ?>
            <div class="card">
                <div class="card-body">
            ...
            <div class="card shadow-sm" style="margin-top: 20px;">
                <div class="card-body">
                    ...
                    <a href="<?= site_url('mahasiswa/discussion/detail/' . $d->id_forum); ?>"
