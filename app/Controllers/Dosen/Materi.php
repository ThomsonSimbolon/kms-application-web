...
{
    protected $materiModel, $userModel, $dosenModel;
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'active' => 'materi',
            'subtitle' => 'materi',
            'materies' => $this->materiModel->getMateriByUser($id_user), // Ambil data materi dari session
        ...
        return view('dosen/v_materi', $data);
    }
    ...
    public function pribadi()
    {
        ...
        return view('dosen/pribadi/v_materi', $data);
    }
    ...
    public function add()
    {
        ...
        return view('dosen/v_tambah_materi', $data);
    }
    ...
    public function create()
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->materiModel->insert($data)) {
                ...
                return redirect()->to('/dosen/materi')->with('success', 'Data berhasil ditambahkan dan sedang diproses.');
            } else {
                // Menampilkan pesan materi gagal ditambah
                session()->setFlashdata('pesan', 'Data gagal ditambahkan');
                return redirect()->to('/dosen/materi')->with('error', 'Data gagal ditambahkan');
            }
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('dosen/v_edit_materi', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->materiModel->update($id, $data)) {
                ...
                return redirect()->to('/dosen/materi')->with('success', 'Data berhasil diubah');
            } else {
                // Menampilkan pesan materi gagal diubah
                session()->setFlashdata('pesan', 'Materi gagal diubah');
                return redirect()->to('/dosen/materi')->with('error', 'Data gagal diubah');
            }
        }
    }
    ...
    public function detail($id)
    {
        ...
        return view('dosen/v_detail_materi', $data);
    }
    ...
    public function download($id)
    {
        ...
        $materi = $model->getAllMateri($id);
        $materi = $model->find($id);

        if ($materi) {
            $filePath = ROOTPATH . 'public/uploads/' . $materi->file_path;
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/dosen/materi')->with('success', 'Materi berhasil dihapus');
    }
}
