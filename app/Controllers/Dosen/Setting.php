...
class Setting extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('dosen/v_setting', $data);
    }
    ...
    public function edit()
    {
        ...
        return view('dosen/v_edit_setting', $data);
    }
    ...
    public function update()
    {
        ...
        if (!$this->validate($validationRules)) {
            return redirect()->to('/dosen/setting')->withInput()->with('errors', $this->validator);
        }
        ...
        if ($this->userModel->update($id_user, $data)) {
            ...
            return redirect()->to('/dosen/setting')->with('success', 'Data berhasil diubah.');
        } else {
            ...
            return redirect()->to('/dosen/setting')->with('error', 'Data gagal diubah.');
        }
    }
}
